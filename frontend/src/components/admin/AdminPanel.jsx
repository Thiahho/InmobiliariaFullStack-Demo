...
const cards = [
  { key: "propiedades", title: "Propiedades", count: 128 },
  { key: "agentes", title: "Agentes", count: 12 },
  { key: "leads", title: "Leads", count: 57 },
  { key: "visitas", title: "Visitas", count: 31 },
];
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((c) => (
            <div key={c.key} className="rounded-lg border bg-white p-5 shadow-sm">
